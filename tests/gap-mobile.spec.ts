...
/**
 * Mobile Gap Consistency Test
 * Tests gap consistency on mobile viewports only.
 */

const PORT = 3000;
const GAP_TOLERANCE = 2;

test('mobile gaps should be consistent (375px)', async ({ page }) => {
    ...
    console.log('--- Mobile Gap Analysis (375px) ---');
