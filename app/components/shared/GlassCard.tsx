...
/**
 * Common glass card styles for spreading into `css({ ... })` — `css.raw` so
 * Panda extracts atoms when merged in consuming files.
 */
export const glassCardStyles = css.raw({
  bg: "#000000",
  opacity: 0.7,
  borderRadius: "10px",
  boxShadow: "#00000F 0 0 10px",
 ...
 * every route.
 */
export const glassPanelShellStyles = css.raw({
  borderRadius: "10px",
  boxShadow: "#00000F 0 0 10px",
  bg: "rgba(0, 0, 0, 0.7)",
});
 ...
 */
export const blogArticleShellStyles = css.raw({
